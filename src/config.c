...
config_t config = {
    ...
    /* Ignition */
    {   // Ignition dwell time
        3050, 2900, 2750, 2600, 2500, 2400, 2300, 2200, 2150, 2100, 2050, 2000, 1975, 1950, 1925, 1900
    },
    {   // Injector dwell time battery voltage
        384, 416, 448, 480, 512, 544, 576, 608, 640, 672, 704, 736, 768, 800, 832, 864
    },
    {   // Ignition timing
